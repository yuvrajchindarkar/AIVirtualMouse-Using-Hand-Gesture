    ...
    if len(lmList) != 0:
      ...
      #  print(fingers)
        if (fingers == [0, 0, 0, 0, 0]) & (active == 0):
            mode = 'N'
        elif (fingers == [0, 1, 1, 1, 0] or fingers == [0, 1, 1, 1, 1]) & (active == 0):
            mode = 'Scroll'
            active = 1
     ...
     #   print(mode)
        ...
        if len(lmList) != 0:
            if fingers == [1, 0, 0, 0, 1]:
                putText(mode='sc', loc=(200, 455), color=(0, 255, 0))

                myScreenshot = pyautogui.screenshot(300)
                myScreenshot.save(r'F:\all viraj\vir\major PP\Finl\SS')
